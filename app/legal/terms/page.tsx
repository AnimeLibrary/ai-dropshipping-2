  ...
  return (
    <div style={{ maxWidth: 800, margin: '80px auto', padding: '0 24px', color: 'var(--color-text-primary)', lineHeight: 1.8 }}>
      ...
      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>1. Overview</h2>
        <p>This website is operated by Vexsen. Throughout the site, the terms “we”, “us” and “our” refer to Vexsen. Vexsen offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
      </section>

      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>2. Online Store Terms</h2>
      ...
      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>3. Modifications to the Service and Prices</h2>
      ...
      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>4. Products or Services</h2>
      ...
      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>5. Accuracy of Billing and Account Information</h2>
      ...
      <section style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>6. Govering Law</h2>
